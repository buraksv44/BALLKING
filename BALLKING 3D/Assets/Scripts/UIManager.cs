...
public class UIManager : MonoBehaviour
{
    ...
    [Space]
    public Button Nothanks_Button;
    [Space]
    public Button NextLevel_Button;

    [SerializeField] Text currenttext, nexttext;
    ...
    public void Start()
    {
        ...
        //currenttext.text = PlayerPrefs.GetInt("currentLevel").ToString();
        //nexttext.text=(PlayerPrefs.GetInt("CurrentLevel")+1).ToString();
        

        CoinTextUpdate();
        leveltext();

        //Nothanks_Button.onClick.AddListener(Load_Level);
        //NextLevel_Button.onClick.AddListener(Load_Level);
   ...
   public void leveltext()
    {
        ...
        nexttext.text = (CurrentLevel + 1).ToString();
    }
    ...
    //    string new_Scene_name = "Scene_" + current_Scene_index;
    //    SceneManager.LoadScene(new_Scene_name);

    //}

    public static implicit operator int(UIManager v)
    {
